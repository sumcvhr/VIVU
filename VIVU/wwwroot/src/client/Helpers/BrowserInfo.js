...
class BrowserInfo {
    constructor(isMobileDevice, appName, browserName, userAgent, version) {
    ...
    static MediaDevices() {
        return new Promise((resolve, reject) => {
            let audioInputDevices = new Array();
            let audioOutputDevices = new Array();
            let videoInputDevices = new Array();
            navigator.mediaDevices.enumerateDevices().catch(err => {
                ...
                resolve({
                    ...
                    videoDevices: videoInputDevices, audioDevices: audioInputDevices, speakers: audioOutputDevices
                });
            });
        });
    }
